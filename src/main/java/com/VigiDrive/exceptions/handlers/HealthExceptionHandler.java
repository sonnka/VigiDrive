...
@ControllerAdvice
public class HealthExceptionHandler extends ResponseEntityExceptionHandler {
    @ExceptionHandler(value = HealthException.class)
    public ResponseEntity<Object> handleCustomerException(HealthException exception,
